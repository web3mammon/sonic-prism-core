...
CLIENT_CONFIGS = {
    # ============================================================================
    # 🔧 JAMESON PLUMBING - PLUMBING SERVICES
    # ============================================================================
    os.getenv('PHONE_NUMBER', '+61412987654'): {  # Dynamic phone number
        "client_id": os.getenv('CLIENT_ID', 'au_plmb_default'),
        "business_name": os.getenv('BUSINESS_NAME', 'Your Plumbing Business'),
        "ai_assistant_name": os.getenv('AI_ASSISTANT_NAME', 'Assistant'),
        "industry": "plumbing_services",
        "location": "Australia",
        "region": "au",
        "city": "Melbourne",
        "phone_number": os.getenv('PHONE_NUMBER', '+61412987654'),
        "website": os.getenv('WEBSITE', 'https://yourplumbingbusiness.com.au'),
