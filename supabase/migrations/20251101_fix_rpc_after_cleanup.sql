-- Fix get_client_by_url_params RPC function after cleanup
-- November 1, 2025
-- Removed: trial_calls, trial_calls_used, trial_conversations, trial_conversations_used, trial_starts_at, trial_ends_at, paid_plan_type
-- Added: paid_plan (boolean)
...
GRANT EXECUTE ON FUNCTION public.get_client_by_url_params(text, text, text) TO authenticated;
GRANT EXECUTE ON FUNCTION public.get_client_by_url_params(text, text, text) TO anon;
