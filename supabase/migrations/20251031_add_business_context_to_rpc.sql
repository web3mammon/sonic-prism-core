-- Add business context fields to get_client_by_url_params RPC function
-- November 1, 2025
-- Adds: website_url, business_address, services_offered, pricing_info, target_audience, tone, call_transfer fields
